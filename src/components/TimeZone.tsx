...
import { EMPTY_SEPARATOR, STRING_EMPTY, UNDERSCORE_SEPARATOR, ZONE_FIRST, ZONE_SECOND } from '../constant/constant'
...
function TimeZone() {
    ...
    function zoneNameFormatter(zoneName: string, type: string) {
        ...
        if (type === ZONE_SECOND) {
            ...
            formattedName = matchResult?.[1]?.replace(UNDERSCORE_SEPARATOR, EMPTY_SEPARATOR) + EMPTY_SEPARATOR + (matchResult?.[2] || STRING_EMPTY);
        }
