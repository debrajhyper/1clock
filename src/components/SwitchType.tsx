    ...
    return (
        <div className="py-0">
            <Switch
                ...
                className={`${isDigital ? 'bg-purple-850' : 'bg-purple-1000'} m-2 relative inline-flex h-[29px] w-[61px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white/62`}
            >
                <span
                    aria-hidden="true"
